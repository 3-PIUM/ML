...
def create_df_from_korean_name(df):
...
if __name__ == "__main__":
    ...
    input_csv = r"C:\Users\user\Desktop\CHOSEIN\coos\COOS_TOTAL.csv"
    output_csv = r"C:\Users\user\Desktop\CHOSEIN\coos\COOS_olive_1.csv"

    df = pd.read_csv(input_csv) 
    partial_df = df.iloc[:10000]  # ← 인덱스로 1~10000번째 행만 선택
    result_df = create_df_from_korean_name(partial_df)
